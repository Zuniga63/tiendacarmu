    ...
    <main style="margin-top: 96px;">
      ...
      <footer class="footer" id="contactanos">
        ...
        <div class="social">
          ...
          <a class="social__link" href="https://www.instagram.com/carmutienda/" target="blank">
            <i class="icon-instagram"></i>
            <span class="social__text__body">Instagram</span>
          </a>
          <a href="https://api.whatsapp.com/send?phone=573205555387&text=Quiero%20mas%20informacion" class="social__link" target="blank"><i class="icon-whatsapp-bold"></i><span>320-555-5387</span></a>
        </div>
