          ...
          <div class="slider__items">
            ...
            <!-- <div class="slider__item">
                <article class="card">
                  <header class="card__header">
                    <div
                      class="card__sticker card__sticker--left card__sticker--new"
                    >
                      New
                    </div>
                    <figure class="card__fig">
                      <img
                        src="./img/productos/Bolsos/Bolso_cambri_azul.jpg"
                        alt="Bolso_cambri_azul"
                        class="card__img"
                      />
                    </figure>
                    <div class="card__gallery">
                      <figure class="card__gallery__item">
                        <img
                          src="./img/productos/Bolsos/Bolso_cambri_rosado.jpg"
                          alt=""
                          class="card__gallery__img"
                        />
                      </figure>
                    </div>
                    <div class="card__pill">Imagenes</div>
                  ...
                  <div class="card__body">
                    <div class="container-flex">
                      <p class="card__old-price">$150,000</p>
                      <p class="card__free-shipping">Entrega inmediata</p>
                    </div>
                    <div class="container-flex">
                      <p class="card__retail-price">$120,000</p>
                      <p class="card__off">10% <span>Dct</span></p>
                    </div>
                    <p class="card__item-name">Bolso cambrí</p>
                  </div>
                </article>
              </div>
              ...
              <div class="slider__item">
                <article class="card">
                  <header class="card__header">
                    ...
                    <figure class="card__fig">
                      <img
                        src="./img/productos/Bolsos/Bolso_startgirl_L.jpg"
                        alt="Bolso_cambri_azul"
                        class="card__img"
                      />
                    </figure>
                    <div class="card__gallery disabled">
                      <figure class="card__gallery__item">
                        <img
                          src="./img/productos/Bolsos/Bolso_cambri_rosado.jpg"
                          alt=""
                    ...
                    <div class="card__pill disabled">Imagenes</div>
                  </header>
                  <div class="card__body">
                    <div class="container-flex">
                      <p class="card__old-price"></p>
                    ...
                    <div class="container-flex">
                      <p class="card__retail-price">$129,900</p>
                      <p class="card__off disabled">10% <span>Dct</span></p>
                    </div>
                    <p class="card__item-name">Morral de niña Totto Star Girls M</p>
                  </div>
                </article>
              </div>
              ...
              <div class="slider__item">
                <article class="card">
                  <header class="card__header">
                    <div
                      class="card__sticker card__sticker--left card__sticker--new disabled"
                    >
                      New
                    </div>
                    <figure class="card__fig">
                      <img
                        src="./img/productos/Bolsos/Mochila_mediana_estampada_rayol.jpg"
                        alt="Bolso_cambri_azul"
                        class="card__img"
                      />
                    </figure>
                    <div class="card__gallery">
                      <figure class="card__gallery__item">
                        <img
                          src="./img/productos/Bolsos/Mochila_mediana_estampada_rayol_morado.jpg"
                          alt=""
                          class="card__gallery__img"
                        />
                      </figure>
                      ...
                      <figure class="card__gallery__item">
                        <img
                          src="./img/productos/Bolsos/Bolso_tempera_azul.jpg"
                          alt=""
                          class="card__gallery__img"
                        />
                      </figure>
                  ...
                  <div class="card__body">
                    <div class="container-flex">
                      <p class="card__old-price">$79,900</p>
                      <p class="card__free-shipping">Ultimas unidades</p>
                    </div>
                    <div class="container-flex">
                      <p class="card__retail-price">$64,000</p>
                      <p class="card__off">20% <span>Dct</span></p>
                    </div>
                    <p class="card__item-name">Morral Tempera Rayol Totto</p>
                  </div>
                </article>
              </div> -->
            ...
            <!-- <div class="slider__item">
              <article class="card">
                <header class="card__header">
                  ...
                  <figure class="card__fig">
                    <img src="./img/Temporal/zegaret_Q&Q_s312-802_02.jpeg" alt="Zegaret" class="card__img" />
                  </figure>
                  <div class="card__gallery">
                    <figure class="card__gallery__item">
                      <img src="./img/Temporal/zegaret_Q&Q_s312-802_01.jpg" alt="" class="card__gallery__img" />
                    </figure>

                    <figure class="card__gallery__item">
                      <img src="./img/Temporal/zegaret_Q&Q_s312-802_03.jpeg" alt="" class="card__gallery__img" />
                    </figure>
                  </div>
                  <div class="card__pill">Imagenes</div>
                </header>
                <div class="card__body">
                  ...
                  <div class="container-flex">
                    <p class="card__retail-price" style="display: none;">
                      $64,000
                    </p>
                    <p class="card__off" style="display: none;">
                      20% <span>Dct</span>
                    </p>
                  </div>
                  <p class="card__item-name">Zegaret Q&Q superior S312-802</p>
                </div>
              </article>
            </div> -->
            ...
            <!-- <div class="slider__item">
              <article class="card">
                <header class="card__header">
                  ...
                  <figure class="card__fig">
                    <img src="./img/Temporal/perfume_disel_zero_plus_female_75ml_1.jpg" alt="Zegaret" class="card__img" />
                  </figure>
                  <div class="card__gallery">
                    <figure class="card__gallery__item">
                      <img src="./img/Temporal/perfume_disel_zero_plus_female_75ml_2.jpeg" alt="" class="card__gallery__img" />
                    </figure>
                  </div>
                  <div class="card__pill">Imagenes</div>
                </header>
                <div class="card__body">
                  ...
                  <div class="container-flex">
                    <p class="card__retail-price" style="display: none;"></p>
                    <p class="card__off" style="display: none;">
                      <span>Dct</span>
                    </p>
                  </div>
                  <p class="card__item-name">
                    Perfume Diesel Zero Plus para Mujer de Diesel Eau de
                    Toilette 75ml
                  </p>
                </div>
              </article>
            ...
            <!-- <div class="slider__item">
              <article class="card">
                <header class="card__header">
                  ...
                  <figure class="card__fig">
                    <img src="./img/Temporal/escapulario_acero_1.jpeg" alt="Zegaret" class="card__img" loading="lazy" />
                  </figure>
                  <div class="card__gallery" style="display: none;">
                    <figure class="card__gallery__item">
                      <img src="./img/Temporal/perfume_disel_zero_plus_female_75ml_2.jpeg" alt="" class="card__gallery__img" loading="lazy" />
                    </figure>
                  </div>
                  <div class="card__pill" style="display: none;">
                    Imagenes
                  </div>
                </header>
                <div class="card__body">
                  ...
                  <p class="card__item-name">Escapulario en acero Brilho</p>
                </div>
              </article>
            </div> -->
          </div>
