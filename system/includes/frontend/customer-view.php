          ...
          <section class="view__section">
            <div class="container">
              ...
              <form class="form form--bg-light">
                ...
                <label for="regCustomerLastName" class="form__label"
                  >Apellidos</label
                >
                <input
                  type="text"
                  name="regCustomerName"
                  id="regCustomerLastName"
                  class="form__input"
                  placeholder="Ingresa el apellido aquí"
                />

                <!-- Campo para la identificacion -->
                <label for="regCustomerNit" class="form__label">Nit o C.C</label>
                <input
                  type="text"
                  name="regCustomerName"
                  id="regCustomerNit"
                ...
                />
                <p class="alert alert--danger show">Identificación repetida</p>

                <!-- Campo para el numero de telefono -->
                <label for="regCustomerPhone" class="form__label">Telefono</label>
                <input
                  type="text"
                  name="regCustomerName"
                  id="regCustomerPhone"
                ...
                />
                <p class="alert alert--danger show">Telefono asignado</p>

                <!-- Campo para el correo elecctronico -->
                <label for="regCustomerPhone" class="form__label">Correo</label>
                <input
                  type="email"
                ...
                />
                <p class="alert alert--danger show">Correo Asignado</p>
                ...
                <div class="form__actions-double">
                  <input
                    type="submit"
                    value="Actualizar"
                ...
                <div class="card-container__options">
                  <div class="form__group-flex">
                    <div class="form__radio-group">
                      <input type="radio" name="active" id="customerActive" class="form__radio">
                      <label for="customerActive" class="form__radio">Act</label>
                    </div>

                    <div class="form__radio-group">
                      <input type="radio" name="active" id="customerActive" class="form__radio">
                      <label for="customerActive" class="form__radio">Inact</label>
                    </div>

                    <div class="form__radio-group">
                      <input type="radio" name="active" id="customerActive" class="form__radio">
                      <label for="customerActive" class="form__radio">Arch</label>
                    </div>
                  </div>
                </div>
                <div class="card-container__box scroll">
                  <div class="card-simple">
                    <p class="card-simple__title">Nombre del cliente bastante largo</p>
                    <div class="card-simple__actions">
                      <button class="btn btn--success">Actualizar Datos</button>
                    </div>
                  </div>
                </div>
                <p class="card-container__footer">Clientes: 0</p>
              </div>
            </div>
          </section>
          <aside class="view__sidebar">
            ...
            <div class="history__body scroll">
              <table class="table">
                <tbody class="table__body">
                  <tr class="table__row">
                    <td class="table__data table--25">Argelino y un poco mas largo</td>
                    <td class="table__data table--25">Pan y Vino</td>
                    <td class="table__data table--25">321-319-8846</td>
                    <td class="table__data table--25"><input type="checkbox" name="" id="" style="zoom:2"></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div class="history__footer">
              <p></p>
              <p class="history__info">Clientes: 0</p>
            </div>
          </aside>
        </div>
  </div>
